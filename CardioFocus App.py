...
# VO2max Estimator
st.markdown("<br><div class='big-font'>VO2max calculator (3-minute step test)</div>", unsafe_allow_html=True)
...
if st.button("Estimate VO2max"):
    ...
    st.success(f"Estimated VO2max: {vo2max:.2f} ml/kg/min")
